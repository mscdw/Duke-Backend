...
*  **Monitoring & Logging:**
  *  Our software will be configured to produce logs to standard out that can be ingested by your enterprise logging and monitoring tools (e.g., Splunk, AWS CloudWatch Logs), which your teams will manage.
